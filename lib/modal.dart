class User {
   ...
   String _email;
   String _number;
  User(this._nom, this._profilimage,this._covimage,this._exper,this._grad,this._wilaya,this._location,this._timing,this._email,this._number);
  User.int(this._id,this._nom, this._profilimage,this._covimage,this._exper,this._grad,this._wilaya,this._location,this._timing,this._email,this._number);
